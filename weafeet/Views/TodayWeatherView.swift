...
struct TodayWeatherView: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            .background(RoundedRectangle(cornerRadius: 20).fill(LinearGradient(gradient: Gradient(colors: [Color.blue.opacity(0.5)]), startPoint: .top, endPoint: .bottom)).opacity(0.3))
